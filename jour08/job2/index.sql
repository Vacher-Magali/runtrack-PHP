...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 22 jan. 2025 à 18:34
...
INSERT INTO `étudiants` (`id`, `Nom`, `Prénom`, `Naissance`, `Sexe`, `Email`) VALUES
...
INSERT INTO `salles` (`id`, `Nom`, `id_etage`, `Capacites`) VALUES
(1, 'Lounge', 1, 100),
(2, 'Studio Son', 1, 5),
(3, 'Broadcasting', 2, 50),
(4, 'Bocal Peda', 2, 4),
